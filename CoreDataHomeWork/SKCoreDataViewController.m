...
@interface SKCoreDataViewController ()

@end

@implementation SKCoreDataViewController

- (NSManagedObjectContext *) managedObjectContext {
    
    if (!_managedObjectContext) {
        _managedObjectContext = [[[SKDataManager sharedManager] persistentContainer] viewContext];
    }
